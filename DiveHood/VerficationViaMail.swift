...
class VerficationViaMail: UIViewController {
    ...
    func setupUi(){
        ...
        let MarkableShape = Markable_Shape(frame: frame, BoldText: "VERFIY ",NormalText: "via Email" ,view: self.view)
        ...
        midLabel.OneLine(fontName: "OpenSans", FontSize: view.frame.height*0.0254 , text : "Haven’t received your email yet?" ,textColor: .white)
        view.addSubview(midLabel)
        midLabel.frame.origin.x = view.frame.width/2 - midLabel.frame.width/2
        let codeTXF = CustomizedTextField (frame: CGRect(x: view.frame.width*0.09, y: view.frame.height*M.HEIGHT_16 + midLabel.frame.maxY, width: view.frame.width*0.82, height: view.frame.height*0.07) , PlaceHolder: "* Enter Your Email To resend" , view: view)
    ...
    func welcomeHeader(_ height : CGFloat)->CGFloat{
        ...
        var frame = CGRect(x: view.frame.width/2-(view.frame.width*0.7/2), y: view.frame.height*M.HEIGHT_16+height, width: view.frame.width*0.7, height: view.frame.height*0.06)
        ...
        frame = CGRect(x: view.frame.width/2-(view.frame.width*0.6/2), y: view.frame.height*M.HEIGHT_16+welcomelabel.frame.maxY, width: view.frame.width*0.6, height: view.frame.height*0.07)
        
        let secondlabel = CustomeLabel(frame: frame, text:"Check your email to recieve your confirmation link", adjustTofit: false, size: view.frame.height*0.02, fontName: "OpenSans")
    ...
    func lastPart(_ y :CGFloat){
        ...
        let button = ButtonWithGradient(frame: CGRect(x: view.frame.width*0.09 , y: y+view.frame.height*M.HEIGHT_32, width: view.frame.width*0.82, height: view.frame.height*0.07), title: "RESEND E-MAIL", view: self.view)
        ...
        lastParagraph.text = "Often, confirmation emails will get caught in a spam filter, so be sure ?to look there."
